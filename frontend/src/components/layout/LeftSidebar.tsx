                ...
                <div>
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="font-bold flex items-center gap-2">
                            Event Types <span className="bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded text-xs font-medium text-slate-500">4</span>
                        </h3>
                    ...
                    {eventTypeDefault.map((type) => (
                        <div key={type.type} className="space-y-1">
                            <Button variant="ghost" className="w-full justify-start gap-3 px-2 font-medium hover:bg-slate-50 dark:hover:bg-slate-800 h-10 capitalization">
